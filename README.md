...
- <img src="https://www.google.com/s2/favicons?domain=adkit.so&sz=64" height="14"/> [AdKit — Ads MCP](https://github.com/adkit/ads-mcp) - Ads MCP to create, launch & analyze ad campaigns and spy on competitor ads across Google Ads, Meta Ads, TikTok Ads, and Reddit Ads — from Claude, Cursor, or ChatGPT. Draft-first, multi-account.
<br />
